...
var stagesResource = schema.GroupVersionResource{Group: "apis", Version: "v1alpha1", Resource: "stages"}

var stagesKind = schema.GroupVersionKind{Group: "apis", Version: "v1alpha1", Kind: "Stage"}
...
func (c *FakeStages) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(stagesResource, c.ns, name, opts), &v1alpha1.Stage{})
